...
namespace ElevateHandle
{
    public unsafe static class ElevateHandle
    {
        ...
        private static ulong GetKernelBase()
        {
            ...
            uint status = NT.NtQuerySystemInformation(11, buffer, (uint)bufferSize, out bufferSize);
            ...
            if (status == 0xC0000004L)
            {
                ...
                status = NT.NtQuerySystemInformation(11, buffer, (uint)bufferSize, out bufferSize);
            }
